...
;
/* SiteCatalyst code version: H.26. Copyright 1996-2013 Adobe, Inc. All Rights Reserved. More info available at http://www.omniture.com (2015-02-03) */
if(typeof(s_account)== "undefined"){
    s_account="timefoodandwine";
}
if(/(file:\/\/\/|localhost|v5\.timeinc\.net|preview\.foodandwine\.com|qa\.foodandwine\.com|editor\.foodandwine\.com|dev\.foodandwine\.com|beta\.www\.foodandwine)/.test(location.href)){s_account="timefoodandwinedev";}
var s_time_rsid2="timeglobalvideo";
/* Dynamic account update */
if(/(file:\/\/\/|localhost|v5\.timeinc\.net|preview\.foodandwine\.com|qa\.foodandwine\.com|beta\.www\.foodandwine)/.test(location.href)){s_time_rsid2="timeglobalvideodev";}
var s_time=s_gi(s_account);
var s_account2=s_account+','+s_time_rsid2;
/************************** CONFIG SECTION **************************/
s_time.charSet="ISO-8859-1";
...
s_time.linkInternalFilters="javascript:,foodandwine.com";
s_time.linkLeaveQueryString=true;
...
s_time.prop10 = location.protocol+"//"+location.host+location.pathname;
s_time.prop17 = window.location.href;
}
s_time.prop23='D=User-Agent';
s_time.prop47 = 'H.26-2015.02.03';
/* search term */
if(location.href.indexOf('search') >-1) {
if(/(^(.*)\/(search)\/(.*)$)/.test(window.location.href)) {if(typeof(RegExp.$4)=='string'){s_time.prop18 = RegExp.$4}}}
/* query params */
s_time.campaign=s_time.getQueryParam('xid');
if(!s_time.campaign)
	s_time.campaign=s_time.getQueryParam('fb_ref'); 

s_time.eVar1=s_time.getQueryParam('cid,iid');
s_time.eVar2=s_time.getQueryParam('pkw'); // 180 days
s_time.eVar15=s_time.getQueryParam('pkw'); // single visit
...
/* copies of props */
s_time.eVar19 = 'D=c19'; // author
s_time.eVar23 = 'D=pageName'; // page name
s_time.eVar24 = 'D=c16'; // channel
s_time.eVar27 = 'D=c15'; // content type
s_time.eVar28 = 'D=c5'; // subchannel
s_time.eVar35 = 'D=c9'; // canonical URL
s_time.eVar41 = 'D=c13'; // content id
s_time.eVar42 = 'D=c20'; // publish date
/* referrer override code  */
var tempRef;
tempRef=s_time.getQueryParam('origref')
if(tempRef)s_time.referrer=tempRef;
/* socialPlatforms v1.0 - used for SocialAnalytics */
s_time.socialPlatforms();
/* multisuite video */
...
var player;var modVP;var modExp;var modCon;var mediaFriendly;var mediaName;var mediaID=0;var tempMediaID=0;var onPlayCalled = false;var mediaLength;
...
s_time.comscoreId = "FoodAndWine.com"; // comscore site
s_time.nielsenCust = "us-100120"; // nielsen customer
s_time.nielsenSite = ""; // nielsen site TBD
/* BC multi-player code */
var players=[];
...
(s_time.channel && s_time.prop16) ? s_time.contextData['bc_channel']=s_time.channel+': '+s_time.prop16 : s_time.contextData['bc_channel']='fw: unknown';
...
if(typeof media_customFields.ramp_franchise == 'string') { media_franchise = media_customFields.ramp_franchise.toLowerCase();}
...
if (mediaID!=tempMediaID) {onPlayCalled=false;}
if (onPlayCalled!=true && mediaID!=tempMediaID && mediaOffset==0){
...
s_time.repl=new Function("x","o","n",""
+"var i=x.indexOf(o),l=n.length;while(x&&i>=0){x=x.substring(0,i)+n+x."
+"substring(i+o.length);i=x.indexOf(o,i+l)}return x");
/* Plugin: socialPlatforms v1.1 */
s_time.socialPlatforms=new Function("a",""
+"var s=this,g,K,D,E,F,i;g=s.referrer?s.referrer:document.referrer;g=g."
+"toLowerCase();K=s_time.split(s_time.socPlatList,'|');for(i=0;i<K.length;i++){"
+"D=s_time.split(K[i],'>');if(g.indexOf(D[0])!=-1){s_time.contextData['a.socialcontentprovider']=D[1];}}");
s_time.socPlatList="facebook.com>Facebook|twitter.com>Twitter|t.co/>Twitter|youtube.com>Youtube|clipmarks.com>Clipmarks|dailymotion.com>Dailymotion|delicious.com>Delicious|digg.com>Digg|diigo.com>Diigo|flickr.com>Flickr|flixster.com>Flixster|fotolog.com>Fotolog|friendfeed.com>FriendFeed|google.com/buzz>Google Buzz|buzz.googleapis.com>Google Buzz|plus.google.com>Google+|hulu.com>Hulu|identi.ca>identi.ca|ilike.com>iLike|intensedebate.com>IntenseDebate|myspace.com>MySpace|newsgator.com>Newsgator|photobucket.com>Photobucket|plurk.com>Plurk|slideshare.net>SlideShare|smugmug.com>SmugMug|stumbleupon.com>StumbleUpon|tumblr.com>Tumblr|vimeo.com>Vimeo|wordpress.com>WordPress|xanga.com>Xanga|metacafe.com>Metacafe|pinterest.com>Pinterest";
/* socialAuthors v1.5.2 */
s_time.socialAuthors=new Function("",""
...
s_time.socialAuthorSearch=new Function("obj",""
...
s_time.maxDelay='3000';//max time to wait for 3rd party api response in milliseconds
s_time.loadModule("Integrate")
s_time.Integrate.onLoad=function(s,m){
s_time.socialAuthors();
};
/****************************** MODULES *****************************/
/* Module: Media */
...
s_time.m_i("Media");
/* Module: Integrate */
s_time.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable=0;p"
