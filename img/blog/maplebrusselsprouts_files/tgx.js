...
function TiiAdTrackRevSci() {
	if (typeof(DM_tag) == "function" && typeof(s_time) == "object") {
        ...
        if ((typeof(TGX_SITE_CONFIG) !=='undefined' && TGX_SITE_CONFIG.bluekai_init === false)) {
        } else {
...
function TgxAdBridge_getSlotFilteredSiteName() {
    ...
    var mobflag = filteredSitename.search("_mob");
    if (mobflag !== -1) {
	filteredSitename = filteredSitename.replace(/_mob.*/i, "");
    }
...
function Tgx_vrinit() {
    if(typeof TGX_SITE_CONFIG != 'undefined' && typeof TGX_SITE_CONFIG.VR_CONFIG != 'undefined' && typeof TGX_SITE_CONFIG.VR_CONFIG.enabled != 'undefined' && TGX_SITE_CONFIG.VR_CONFIG.enabled) {
        var src;
        if (TiiAd_isSecure()) {
            src = 'https://a248.e.akamai.net/f/1016/606/2d/tiads-ssl.timeinc.net/ads/tgxvrs.js';
        } else {
            src = 'http://tiads.timeinc.net/ads/tgxvrs.js';
        }
...
function Tgx_OneBotinit(){
    ...
    if (TIICONSTANTS.onebot_allow_deny_mode == "allow") {
        if (TIICONSTANTS.onebot_enabled_root_domains.indexOf(domain) >= 0) {
            ...
            if(TiiAd_isSecure()) {
                OneBotUrl = "https://d1oggnumqrlfic.cloudfront.net/trending.json?url=" + cleanUrl;
            }
            else{
                OneBotUrl = "http://cdn.api.onebot.timeinc.com/trending.json?url=" + cleanUrl;    
            }
